...
var defaultMessages = {
  ...
  yesterday: 'Ayer',
  tomorrow: 'Mañana',
  today: 'Hoy', // Farid formatted_date.toString(),
  agenda: 'Turnos',
  noEventsInRange: 'No hay turnos esta semana.',
  ...
  _proto.renderShowMore = function renderShowMore(segments, slot) {
    ...
    React.createElement("i", 
        { 
          href: '#', 
          key: 'sm_' + slot,
          className: 'appointments-ico fas fa-user-md fa-2x',
          onClick: function onClick(e) {
...
var eventsForWeek = function eventsForWeek(evts, start, end, accessors) {
  if(evts.length > 0 && evts !== 'undefined') {
...
function TimeGridEvent(props) {
  ...
  return React.createElement(EventWrapper, _extends({
    ...
    style: _extends({}, userProps.style, (_extends2 = {
      top: top + "%",
      height: height + "%"
    }, _extends2[isRtl ? 'right' : 'left'] = "0%", _extends2)),
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, React.createElement("span", null, localizer.format(selectDates, 'selectRangeFormat'))));
  };
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
      className: "rbc-time-gutters rbc-time-column"
    });
    // OLD code
    // FARID
    /* return React.createElement("div", {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
      ...
      return React.createElement("div", {
        ...
        key: id || idx
      }, "ponele" && resource && React.createElement("div", {
    ...
    _this.renderDay = function (day, events$$1, dayKey) {
      ...
      return events$$1.map(function (event, idx) {
        ...
        return React.createElement("tr", {
          ...
          style: userProps.style}, first, React.createElement("td", {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
      className: "rbc-toolbar d-flex justify-content-center"
    }, 
    // Calendar Header
    React.createElement("span", {
...
// Formato de hora para los turnos en modo 'Agenda'
var dateRangeFormat$1 = function dateRangeFormat(_ref, culture, local) {
  var start = _ref.start
  return local.format(start, 'L', culture);
};

var timeRangeFormat = function timeRangeFormat(_ref2, culture, local) {
  var start = _ref2.start
  return local.format(start, 'LT', culture) + 'h ';
};
...
var timeRangeEndFormat = function timeRangeEndFormat(_ref4, culture, local) {
  var end = _ref4.end;
  return 'h ' + local.format(end, 'LT', culture);
};
...
var weekRangeFormat$1 = function weekRangeFormat(_ref5, culture, local) {
  var start = _ref5.start
  return local.format(start, 'MMM dd', culture) + ' - ';
};
