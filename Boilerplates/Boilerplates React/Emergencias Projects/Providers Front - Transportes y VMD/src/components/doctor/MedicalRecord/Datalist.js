...
class DataListInput extends React.Component {
	...
	/**
     * gets called when someone clicks the input field
     * @param event
     */
	onHandleClick(event) {
		const currentInput = event.target.value;
    ...
    render() {
        ...
        return (
            <div className="datalist-input">
                <textarea onKeyDown={this.onHandleKeydown} onInput={this.onHandleInput} type="text"
                       className="autocompleteInput"
                       placeholder={placeholder} defaultValue={currentInput} onClick={(e) => this.onHandleClick(e)}/>
