(function (global, factory) {
  ...
  (global = global || self, global.ReactBigCalendar = factory(global.React, global.ReactDOM));
  ...
  */
  ...
  function () {
    function Selection(node, _temp) {
      ...
      this._onTouchMoveWindowListener = addEventListener$2('touchmove', function () {}, window);
      this._onKeyDownListener = addEventListener$2('keydown', this._keyListener);
    ...
    _proto._addLongPressListener = function _addLongPressListener(handler, initialEvent) {
      ...
      var touchStartListener = addEventListener$2('touchstart', handleTouchStart);
    ...
    _proto._addInitialEventListener = function _addInitialEventListener() {
      ...
      var mouseDownListener = addEventListener$2('mousedown', function (e) {
        ...
        _this2._onInitialEventListener = addEventListener$2('mousedown', _this2._handleInitialEvent);
      });
    ...
    _proto._handleInitialEvent = function _handleInitialEvent(e) {
      ...
      switch (e.type) {
        case 'mousedown':
          this._onEndListener = addEventListener$2('mouseup', this._handleTerminatingEvent);
          this._onEscListener = addEventListener$2('keydown', this._handleTerminatingEvent);
          this._onMoveListener = addEventListener$2('mousemove', this._handleMoveEvent);
          break;

        case 'touchstart':
          this._handleMoveEvent(e);

          this._onEndListener = addEventListener$2('touchend', this._handleTerminatingEvent);
          this._onMoveListener = addEventListener$2('touchmove', this._handleMoveEvent);
          break;
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement("div", {
        ...
        return React__default.createElement(Wrapper, {
          ...
          style: style,
          className: classnames('rbc-day-bg', className, selected && 'rbc-selected-cell', dates.eq(date, current, 'day') && 'rbc-today', currentDate && dates.month(currentDate) !== dates.month(date) && 'rbc-off-range-bg')
        }));
      }));
    };
  ...
  function (_React$Component) {
    ...
    function DateContentRow() {
      ...
      _this.handleShowMore = function (slot) {
        ...
        var row = qsa(reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))), '.rbc-row-bg')[0];
        var cell;
      ...
      _this.getContainer = function () {
        ...
        return container ? container() : reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this)));
      };
      ...
      _this.renderHeadingCell = function (date, index) {
        ...
        return renderHeader({
          date: date,
          key: "header_" + index,
          className: classnames('rbc-date-cell', dates.eq(date, getNow(), 'day') && 'rbc-now')
        });
      };
  ...
  function (_React$Component) {
    ...
    function MonthView() {
      ...
      _this.handleShowMore = function (events, date, cell, slot) {
        ...
        if (popup) {
          var position = getPosition(cell, reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))));
    ...
    function DayColumn() {
      ...
      _this._selectable = function () {
        ...
        var selectorClicksHandler = function selectorClicksHandler(box, actionType) {
          if (!isEvent(reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))), box)) {
        ...
        selector.on('beforeSelect', function (box) {
          ...
          return !isEvent(reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))), box);
        });
    ...
    _proto.renderHeaderCells = function renderHeaderCells(range) {
      ...
      return range.map(function (date, i) {
        ...
        return React__default.createElement("div", {
          key: i,
          style: style,
          className: classnames('rbc-header', className, dates.eq(date, today, 'day') && 'rbc-today')
  ...
  function (_React$Component) {
    ...
    function Calendar() {
      ...
      _this.getViews = function () {
        ...
        if (Array.isArray(views$$1)) {
          return transform_1(views$$1, function (obj, name) {
    ...
    _proto.getContext = function getContext(_ref2) {
      ...
      return {
        ...
        components: defaults_1(components[view] || {}, omit_1(components, names), {
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement("div", _extends({}, elementProps, {
        className: classnames(className, 'rbc-calendar', props.rtl && 'rbc-is-rtl'),
        style: style
        ...
        localizer: localizer
      }), React__default.createElement(View, _extends({
        ref: "view"
      }, props, {
        events: events,
        date: current,
